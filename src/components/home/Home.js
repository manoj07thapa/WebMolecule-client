		...
		<Layout>
			<Content>
				<div className="carousel">
					<Carousel autoplay>
						{items.map((item, i) => <img key={i} alt="carousel" src={item.src} />)}
					</Carousel>
				</div>
				<div
					className="event"
				...
				<div className="container">
					<div className="margin-main introduction">
						...
						<p>
							Lorem ipsum dolor sit, amet consectetur adipisicing elit. Qui, quos. Expedita ipsa debitis
							hic. Doloribus minima obcaecati illo possimus, saepe et quam labore aperiam ipsa non id
							alias quod expedita!
						</p>
						...
						<p>
							Lorem ipsum dolor sit amet, consectetur adipisicing elit. Totam non soluta deserunt rem!
							Odio, eius non dolor dolores omnis excepturi voluptas officiis tempore asperiores! Iusto
							laboriosam nostrum sapiente exercitationem fugit.
						</p>
						<div className="tool">
				...
				>
					<div style={{ color: 'white', padding: 10 }} className="container">
						...
						<p style={{ paddingTop: 20 }}>
							...
							getting what you wanted? Or realize you don't have the prerequisite information? How often
							do you not even know what to learn? You don't need more free tutorials. You need planned and
							guided learning. You need a learning map!
						</p>
					</div>
				</div>
				<div className="container">
					<Row style={{ marginTop: '7em' }}>
						...
						<Col span={11} offset={2}>
							...
							<p>
								Watching video tutorials is just the beginning. Get hands-on assignments with course
								videos that allow you to actually apply and implement what is being taught in the course
								material. This is active learning!
							</p>
						</Col>
					</Row>
				</div>
